      ...
      <div className="mx-auto grid max-w-[1440px] gap-12 px-5 lg:grid-cols-[2fr_1fr] lg:px-8">
        ...
        <aside className="lg:sticky lg:top-28 lg:h-fit">
          <div className="rounded-[32px] border border-border bg-surface-soft p-8 shadow-sm">
            ...
            <button className="mt-8 w-full rounded-full bg-light-sea-green px-6 py-4 font-semibold text-white transition hover:opacity-90">
              Enquire Now
            </button>

            <button className="mt-4 w-full rounded-full border border-light-sea-green px-6 py-4 font-semibold text-light-sea-green transition hover:bg-light-sea-green hover:text-white">
              WhatsApp Us
            </button>
          </div>
        </aside>
